...
def plot_learning_curve(log_dir, file_name='learning_curve_ppo.png', averaging_window=1):
    ...
    # 특정 구간을 제외한 데이터 필터링
    mask = adjusted_timesteps < 3 * 10 ** 6
    ...
    plt.title('PPO Learning Curve', fontsize=16)
    plt.ylim(-300, 0)
    plt.xlim(0, 2.25 * 10 ** 6)  # x축을 0에서 5,000,000까지 설정하여 오른쪽에 공백 추가
...
if __name__ == '__main__':
    ...
    plot_learning_curve(log_dir, file_name='learning_curve_ppo.png', averaging_window=250)
